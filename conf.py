...
# zen-blog build configuration file, created by
# `ablog start` on Sun Aug  9 20:14:33 2020.
#
...
blog_title = u'Zen Blog'

# Base URL for the website, required for generating feeds.
# e.g. blog_baseurl = "http://example.com/"
blog_baseurl = u'zen.antonoutkine.com'
...
blog_authors = {
    'Anton Outkine': ('Anton Outkine', None),
}
...
project = u'zen-blog'
copyright = u'2020, Anton Outkine'
author = u'Anton Outkine'
